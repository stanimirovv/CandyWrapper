...
function loadCreator() {
    ...
    document.getElementById("dynamic").innerHTML = ' <div class="cont">' +
    '<span class="why">Candies per second:</span>' +
    '<input id="perSec"  type="number" value="0"  /> <br />' +
   ' <span class="why">Candies owned:</span>' +
    '<input id="cOwned"  type="number" value="0" /> <br />' +
  '  <span class="why">Candies eaten:</span>' +
    '<input id="cEaten"  type="number"  value="0"/> <br />' +
   ' <span  class="why">Candies thrown:</span>' +
 '   <input id="cThrown" type="number"  value="0"/> <br />' +
  '  <span  class="why">Lolipops owned:</span>' +
 '   <input id="lOwned" type="number" value="0" /> <br />' +
 '   <span class="why">Lolipops Stock: (set to high numbers, use only if you plan on buying over 1000)</span>' +
    '   <input id="lStock"  type="number"  value="0"/> <br />' +
  ' <span  class="why">Name of Link:</span>' +
 ...
 '  </div>';
    window.setInterval(function () { changeLinktxt() }, 300);
}
